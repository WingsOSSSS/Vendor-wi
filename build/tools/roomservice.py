#!/usr/bin/env python
# Copyright (C) 2023-2024 Project Wings
#
...
custom_dependencies = "wings.dependencies"
org_manifest = "Project-Wings"  # leave empty if org is provided in manifest
org_display = "Project Wings"  # needed for displaying
...
def main():
    ...
    for repository in repositories:
        ...
        adding = [{'repository': "Project-Wings/" + repo_name, 'target_path': repo_path}]
